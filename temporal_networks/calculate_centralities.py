    ...
    **KEY FEATURE:** Automatically detects and reports temporal gaps in your data.
    ...
    for graph_idx, graph in enumerate(graphs):
        ...
        if "name" in graph.vs.attributes():
            ...
            node_labels = [f"Node_{i}" for i in range(v_count)]
