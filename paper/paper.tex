...
\begin{abstract}
\textbf{Background:} Surveillance systems for infectious disease importation rely primarily on monitoring passenger volumes at borders. This approach cannot capture how network structure evolves during a crisis, and structural changes carry distinct implications for importation risk that passenger counts do not reflect. The COVID-19 pandemic provides an unprecedented opportunity to examine how a major public health emergency reshapes global air transportation and what that reshaping means for disease importation risk.

\textbf{Methods:} Monthly directed networks were constructed from ADS-B flight data for January 2019 through December 2021 (36 months), covering airports in Canada, the United States, and Europe. Structural metrics were computed per month: node and edge counts, strongly connected components, betweenness and PageRank centrality, and community structure using Louvain and Infomap algorithms. Edge formation and dissolution were tracked across the full period. Findings were assessed against Statistics Canada international arrival data and documented SARS-CoV-2 variant importation events.

\textbf{Results:} April 2020 saw collapse across all dimensions: passenger volumes fell to 22\% of the prior year, routes declined 40\% from their summer 2019 peak, and network fragmentation increased. Recovery was rapid and ultimately exceeded pre-pandemic levels: nodes surpassed the pre-pandemic peak by June 2020, and routes reached approximately 180,000--190,000 by late 2021, well above the pre-pandemic average of 112,000. International arrivals, however, remained 58\% below pre-pandemic levels by December 2021. Chicago O'Hare maintained dominant betweenness centrality throughout; PageRank showed greater volatility, identifying smaller regional airports as temporarily critical connectors. The timing of Alpha, Delta, and Omicron importation into Canada was temporally consistent with successive stages of network recovery; Omicron arrived within four days of WHO classification during the most advanced period of network reintegration.

\textbf{Conclusions:} Network structure and passenger volume convey distinct, complementary information about importation risk. Structural recovery preceded volumetric recovery by months. Public health agencies require network intelligence alongside passenger volume monitoring, with surveillance resources allocated dynamically based on centrality measures rather than traffic volume alone.
\end{abstract}
...
% ---------------------------------------------------------------
% 3.2 — Volume collapse and structural overview (formerly opening prose)
% ---------------------------------------------------------------
...
% ---------------------------------------------------------------
% 3.3 — Fragmentation and community structure
% ---------------------------------------------------------------
...
% ---------------------------------------------------------------
% 3.4 — Centrality shifts (formerly 3.1)
% ---------------------------------------------------------------
...
Closeness centrality, which measures average shortest-path distance from a node to all others, was computed but showed minimal temporal variation, hovering near the maximum value of 1.0 throughout the 36-month period for the airports with highest scores. Rather than indicating a failure of the metric, this stability is itself epidemiologically informative: the topological skeleton of the North American and European air network is so robust that even a 70\% collapse in passenger volume and a 41\% loss of routes did not meaningfully increase the hop-count between major regions within the giant connected component. Disease introduced at any major hub could still reach any other major hub in approximately the same number of steps in April 2020 as in January 2019. The network compressed in volume and lost peripheral connections, but its core remained compact and topologically intact. Because closeness centrality did not differentiate risk across the study period, we exclude it from the main comparative analysis and focus on the high-variance metrics, betweenness and PageRank, which tracked the pandemic's impact on network structure.

% ---------------------------------------------------------------
% 3.5 — Edge dynamics (formerly 3.2)
% ---------------------------------------------------------------
...
% ---------------------------------------------------------------
% 3.6 — Recovery and persistent vulnerability (formerly 3.3)
% ---------------------------------------------------------------
